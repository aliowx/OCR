...
async def download_excel(
    ...
    *,
    ...
    excel_name: str = datetime.now().date,
) -> APIResponseType[Any]:
    """
    Retrieve plate.
    ...
    path_download, file_name = generate_excel.generate_excel_file(
        data=data, path=path, title=excel_name
    )
    return APIResponse(
        {"path_download": path_download, "file_name": file_name}
    )
...
#     if data is not None:
#         data = json.loads(data)
#     excel_file = generate_excel.generate_excel_stream(
